        ...
        <div class="row">
            ...
            <div class="col-sm-3">
                <div class="center">
                    ...
                    <div class="">
                        <div class="">
                            <h6><a href="{{route('admin.sale.all','turkey')}}">Sales</a></h6>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-3">
                <div class="center">
                <a href="{{route('admin.statement','turkey')}}" data-toggle="modal" data-target="#myModal1" class="offer-img">
                        <i class="fas fa-poll fa-8x"></i>
                    </a>
                    <div class="mid-1">
                        <div class="women">
                            <h6><a href="{{route('admin.statement','turkey')}}">Reports</a></h6>
                        </div>
                    </div>
                </div>
            </div>
