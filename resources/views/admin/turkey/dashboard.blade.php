...
@endsection
@section('profile')
<a class="dropdown-item" href="{{route('admin.profile','turkey')}}">Profile</a>
...
@section('sidenav-links')
    ...
    <div class="collapse" id="collapseSale" aria-labelledby="headingTwo" data-parent="#sidenavAccordion">
        <nav class="sb-sidenav-menu-nested nav">
            ...
            <a class="nav-link collapsed" href="{{route('admin.sale.meat','turkey')}}">
             ...
             <a class="nav-link collapsed" href="{{ route('admin.sale.all','turkey')}}">
                Summary
            </a>
        </nav>
    </div>
    ...
    <div class="collapse" id="collapseLogicstic" aria-labelledby="headingTwo" data-parent="#sidenavAccordion">
        <nav class="sb-sidenav-menu-nested nav">
            <a class="nav-link collapsed" href="{{route('admin.farm.equipment','turkey')}}">
               Equipment
        </nav>
    </div>
    ...
    <div class="collapse" id="collapseFin" aria-labelledby="headingTwo" data-parent="#sidenavAccordion">
        <nav class="sb-sidenav-menu-nested nav">
            <a class="nav-link collapsed" href="{{route('admin.transaction','turkey')}}">
                Transaction
            </a>
            <a class="nav-link collapsed" href="{{route('admin.statement','turkey')}}">
                Statement
            </a>
        </nav>
    </div>
 @if (auth()->user()->hasRole('SUPER_ADMIN'))
       <a class="nav-link collapse" href="#" data-toggle="collapse" data-target="#collapseAdmin" aria-expanded="false" aria-controls="collapseAdmin">
        ...
        <div class="collapse" id="collapseAdmin" aria-labelledby="headingTwo" data-parent="#sidenavAccordion">
            <nav class="sb-sidenav-menu-nested nav">
                <a class="nav-link collapsed" href="{{route('admin.employee','turkey')}}">
                    Employees
                </a>
                <a class="nav-link collapsed" href="{{route('admin.users','turkey')}}">
                    Users
                </a>
            </nav>
        </div>
