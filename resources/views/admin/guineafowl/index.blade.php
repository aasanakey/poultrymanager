...
@section('dash_content')
    <div class="container-fluid mt-4">
        ...
        <div class="row">
            ...
            <div class="col-sm-3">
                <div class="center">
                <a href="{{route('admin.farm.equipment','guinea_fowl')}}" data-toggle="modal" data-target="#myModal1" class="offer-img">
                        <i class="fas fa-tools fa-8x"></i>
                    </a>
                    <div class="mid-1">
                        <div class="women">
                            <h6><a href="{{route('admin.farm.equipment','guinea_fowl')}}">Equipment</a></h6>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-3">
                <div class="center">
                <a href="{{route('admin.statement','guinea_fowl')}}" data-toggle="modal" data-target="#myModal1" class="offer-img">
                        <i class="fas fa-poll fa-8x"></i>
                    </a>
                    <div class="mid-1">
                        <div class="women">
                            <h6><a href="{{route('admin.statement','guinea_fowl')}}">Reports</a></h6>
                        </div>
                    </div>
                </div>
            </div>
